                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="attribute" class="ajax-update" novalidate method="post">
                                    <input type="hidden" name="id" value="{{$attribute->id}}">
                                    @method('put')
                                    <div class="row">
                                        <aside class="col-12 col-md-6">
                                            <x-text-input name="title" label="عنوان" :value="$attribute->title"
                                                          placeholder="عنوان مطلب را وارد کنید"/>
                                            <x-switch name="use_as_filter" label="فعال بودن" type="success"
                                                      :value="$attribute->use_as_filter" id="filter" />
                                            <x-switch label="فعال کردن پالت رنگی" type="success"
                                                       id="is_color" :value="$is_color" />
                                        </aside>
                                                            ...
                                                            <div data-repeater-item>
                                                                <div class="row justify-content-between">
                                                                    <div class="col-md-7 col-sm-12 form-group">
                                                                        <x-text-input label="عنوان گزینه" name="options[][title]" :value="$option->title" placeholder="عنوان گزینه را وارد کنید" />
                                                                    </div>
                                                                    <div class="col-md-3 col-sm-12 form-group">
                                                                        <label for="code">رنگ گزینه</label>
                                                                        <input type="color" class="form-control color" name="options[][code]" value="{{$option->code}}" placeholder="رنگ گرینه را انتخاب کنید کنید">
                                                                    </div>
